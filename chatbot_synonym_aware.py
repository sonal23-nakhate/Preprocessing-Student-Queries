def chatbot():
    print("Welcome to Synonym-Aware FAQ Bot")
            ...
            for word in keywords:
                if word in user:
                    ...
                    if category == "timings":
                        ...
                        print("Bot: Annual tuition fees are ₹85,000.")
